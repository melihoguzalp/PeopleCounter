...
int sensorEngelMesafesi = 50; // Sensör tetiklenmesi için cm değeri
    ...
    while (1) {
      ...
      if (sensor1 == 0 && sensor2 == 0)
        ...
        while (1) {
          ...
          } //else if ( (sensor1 == 1 && sensor2 == 0) || (sensor1 == 1 && sensor2 == 1) )
    ...
    while (1) {
      ...
      if (sensor1 == 0 && sensor2 == 0)
        ...
        while (1) {
          ...
          } //else if ( (sensor1 == 0 && sensor2 == 1) || (sensor1 == 1 && sensor2 == 1) )
